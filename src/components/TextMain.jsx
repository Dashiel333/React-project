...
export default function TextMain() {
  ...
  return (
    <section className="px-4 md:px-12 py-8 flex flex-col md:flex-row justify-center bg-black">
      ...
      <div className="text-white text-5xl max-w-[850px]">
        <ul>
        ...
        <nav className="MoreMenu">
          <p
            ...
            className="text-gray-400 cursor-pointer select-none hover:text-white transition"
          >
            {isOpen ? "-Hide" : "+More"}
          </p>
          {isOpen && (
            <ul className="mt-4 space-y-2 text-4xl text-gray-300">
              <li>Business formation</li>
              <li>Contract drafting</li>
              <li>Mergers and Acquisitions</li>
              <li>Property Protection</li>
